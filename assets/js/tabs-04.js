...
const tabRecords = [
  ...
  {
    company: {
      src: "assets/images/app/meta.svg",
      name: "Meta",
    },
    role: 'Senior Backend Developer',
    type: 'hybrid',
  ...
  const mappedRecords = tabRecords.filter(filterFunction).map(({ company, ...record }) => {
    return DOMPurify.sanitize(
      `<div class="job">
        <div class="job__main">
          ...
          <div class="job__description">
            ...
            <div class="job__location">
              <img src="assets/images/app/location.svg" alt="Location">
              ${record.location}
            </div>
          </div>
        </div>
        ...
        return (
          `<img src="assets/images/app/${applicant}.png" alt="${applicant.name}" class="job__applicant">`
        )
      }).join("")}
