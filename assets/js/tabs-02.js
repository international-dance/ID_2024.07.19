...
const tabRecords = [
  {
    src: 'assets/images/app/space_simulator.png',
    name: 'Space Simulator',
    description: 'Game / Free / Simulation',
    type: 'games',
  },
  {
    src: 'assets/images/app/mechinarium.png',
    name: 'Mechinarium',
    description: 'Game / Paid / Adventure',
    type: 'games',
  },
  {
    src: 'assets/images/app/code-war.png',
    name: 'Code of War',
    description: 'Game / Free / Action',
    type: 'games',
  },
  {
    src: 'assets/images/app/oppenheimer.png',
    name: 'Oppenheimer',
    description: 'Drama / Thriller',
    type: 'movies',
  },
  {
    src: 'assets/images/app/barbie.png',
    name: 'Barbie',
    description: 'Comedy / Drama',
    type: 'movies',
  },
  {
    src: 'assets/images/app/lotr.png',
